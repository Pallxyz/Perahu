    ...
    <div class="container">
        ...
        <div class="left-panel">
            ...
            <div class="welcome-text">
                ...
                <p>Register now and take the first step towards your next adventure</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="tel" id="phone" name="phone" placeholder="+8801724649510"
            ...
            <div class="social-buttons">
                ...
                <button class="social-btn" disabled style="opacity: 0.5; cursor: not-allowed;" title="Coming soon">
